...
public struct Gestalt {
	...
	static public var deviceName: String { rawDeviceType }
		...
		public static func convertRawDeviceTypeToModelName(_ raw: String) -> String? {
			...
			case "Watch4,3": 								return "Apple Watch Series 4 40mm"
			case "Watch4,4": 								return "Apple Watch Series 4 44mm"
			case "Watch5,1": 								return "Apple Watch Series 5 40mm"
			case "Watch5,2": 								return "Apple Watch Series 5 44mm"
			case "Watch5,3": 								return "Apple Watch Series 5 40mm"
			case "Watch5,4": 								return "Apple Watch Series 5 44mm"
